...
const socialLinks = [
  { title: "Thrive in social setting", label: "LinkedIn", url: "https://www.linkedin.com/", icon: "/img/linkedin.svg", color1: "#0077B5", color2: "#005582" }, // Трохи поправив кольори LinkedIn на більш класичні ;)
  { title: "Excel at problem-solving", label: "LeetCode", url: "https://leetcode.com/u/LustForCode/", icon: "/img/leetcode.svg", color1: "#db9915", color2: "#b67d0a" },
  { title: "Unveiling my projects", label: "GitHub", url: "https://github.com/", icon: "/img/github.svg", color1: "#8a23df", color2: "#720dc5" },
  { title: "Get in touch if intrigued", label: "Telegram", url: "https://web.telegram.org/k/#@me_Karoshi", icon: "/img/telegram.svg", color1: "#0f81ca", color2: "#0a6dad" },
];

export default function Connections() {
  return (
    // Знову ж таки, просто звичайний контейнер
    <div className="w-full h-full flex flex-col justify-center items-center px-4 font-aes py-20 bg-transparent">
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
            <motion.div
               variants={{ initial: { opacity: 0, scale: 0.5, rotate: -20 }, hover: { opacity: 1, scale: 1, rotate: 0 } }}
            ...
            >
               <img src={link.icon} alt={link.label} className="w-8 h-8 object-contain dark:invert opacity-80" />
            </motion.div>
            <motion.span 
